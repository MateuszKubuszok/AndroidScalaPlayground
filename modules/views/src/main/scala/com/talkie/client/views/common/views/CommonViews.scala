...
trait CommonViews {
  ...
  object attribute {
    import com.talkie.client.views.R.{ attr => a }

    lazy val actionBarSize = findDimension(resolve(a.actionBarSize))
  }

  object color {
    import com.talkie.client.views.R.color._
  ...
  object dimension {
    import com.talkie.client.views.R.dimen._
  ...
  object drawables {
    ...
    import com.talkie.client.views.R.drawable._
  ...
  object themes {
    import com.talkie.client.views.R.style._
